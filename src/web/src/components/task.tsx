...
export const Task = () => {
  ...
  const setExample = () => {
    ...
    setWriting(
      "Write a fun and engaging article that includes the research and information information. The article should be between 800 and 1000 words. Make sure to cite sources in the article as you mention the research not at the end."
    );
  };
